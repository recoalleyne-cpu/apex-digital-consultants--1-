...
const WHATSAPP_URL = 'https://wa.me/12468416543';
...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-4 right-3 sm:bottom-6 sm:right-6 z-[100] flex items-center gap-3">
      ...
      <motion.button
        ...
        aria-label="Contact Apex Digital Consultants on WhatsApp"
      >
