...
const DEFAULT_APEX_GA4_MEASUREMENT_ID = 'G-CK6Q8YXX28';
...
const BUILD_TIME_ENV_FALLBACKS: Record<string, unknown> = {
  VITE_GOOGLE_TAG_ID: __APEX_GOOGLE_ANALYTICS_ID__,
  NEXT_PUBLIC_GOOGLE_TAG_ID: __APEX_GOOGLE_ANALYTICS_ID__,
  GOOGLE_TAG_ID: __APEX_GOOGLE_ANALYTICS_ID__,
