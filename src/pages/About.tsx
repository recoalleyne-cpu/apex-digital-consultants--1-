        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="order-2 lg:order-1 space-y-8">
              <span className="text-sm font-semibold tracking-widest text-apex-yellow uppercase mb-4 block">The Visionary</span>
              <h2 className="heading-lg mb-8">Meet Our Founder</h2>
              <p className="text-lg text-apple-gray-300 leading-relaxed">
            ...
            <div className="order-1 lg:order-2 relative">
              ...
              {/* Decorative element */}
              <div className="absolute -bottom-6 -right-6 w-64 h-64 bg-apex-yellow/10 rounded-full blur-3xl -z-0" />
      ...
      <section className="section-padding bg-apple-gray-500 text-white">
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-apex-yellow">Strategy</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-6 text-apex-yellow">Creativity</h3>
              <p className="text-apple-gray-200 leading-relaxed">
                We bring fresh perspectives and innovative designs that make your brand stand out.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-6 text-apex-yellow">Precision</h3>
              <p className="text-apple-gray-200 leading-relaxed">
